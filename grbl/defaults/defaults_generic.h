...
#define defaults_h
  ...
  #define DEFAULT_X_STEPS_PER_MM 43.78
  #define DEFAULT_Y_STEPS_PER_MM 43.78
  #define DEFAULT_Z_STEPS_PER_MM 43.78
  #define DEFAULT_X_MAX_RATE 10000.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 10000.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 10000.0 // mm/min
  #define DEFAULT_X_ACCELERATION 300 // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Y_ACCELERATION 300 // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Z_ACCELERATION 150 // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_X_MAX_TRAVEL 155.0 // mm
  #define DEFAULT_Y_MAX_TRAVEL 204.0 // mm
  #define DEFAULT_Z_MAX_TRAVEL 69.0 // mm
